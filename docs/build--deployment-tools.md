...
- [Ghost in the Droid](https://ghostinthedroid.com): Give any LLM agent a real Android or iPhone as its body. 62 MCP tools: tap, swipe, screenshot, screen-tree reading, app launch, on-device inference (llama.cpp, MediaPipe, MLX), Docker+KVM emulator pools. Works with Claude Code, Cursor, LangChain, and any MCP client.
