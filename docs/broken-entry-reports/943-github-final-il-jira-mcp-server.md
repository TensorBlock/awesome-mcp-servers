# Broken entry report: https://github.com/final-il/jira-mcp-server

Status: needs verification
Source issue: https://github.com/TensorBlock/awesome-mcp-servers/issues/943

## Entry Reference

https://github.com/final-il/jira-mcp-server
...
GitHub API returned 404 for https://github.com/final-il/jira-mcp-server.

Indexed server id: github-final-il-jira-mcp-server-1919acdb
Name: final-il/jira-mcp-server
Category: Project & Task Management
Source docs: docs/project--task-management.md
