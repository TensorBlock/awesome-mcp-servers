# Broken entry report: https://github.com/husqvaluna/spike-symbol-mcp-server

Status: needs verification
Source issue: https://github.com/TensorBlock/awesome-mcp-servers/issues/980

## Entry Reference

https://github.com/husqvaluna/spike-symbol-mcp-server
...
GitHub API returned 404 for https://github.com/husqvaluna/spike-symbol-mcp-server.

Indexed server id: github-husqvaluna-spike-symbol-mcp-server-158e1392
Name: husqvaluna/spike-symbol-mcp-server
Category: Science & Research
Source docs: docs/science--research.md
