# Broken entry report: https://github.com/attilad/bgg-mcp-server

Status: needs verification
Source issue: https://github.com/TensorBlock/awesome-mcp-servers/issues/843

## Entry Reference

https://github.com/attilad/bgg-mcp-server
...
GitHub API returned 404 for https://github.com/attilad/bgg-mcp-server.

Indexed server id: github-attilad-bgg-mcp-server-e27d89bc
Name: attilad/bgg-mcp-server
Category: Gaming
Source docs: docs/gaming.md
