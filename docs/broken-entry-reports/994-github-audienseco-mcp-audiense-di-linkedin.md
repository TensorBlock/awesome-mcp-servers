# Broken entry report: https://github.com/AudienseCo/mcp-audiense-di-linkedin

Status: needs verification
Source issue: https://github.com/TensorBlock/awesome-mcp-servers/issues/994

## Entry Reference

https://github.com/AudienseCo/mcp-audiense-di-linkedin
...
GitHub API returned 404 for https://github.com/AudienseCo/mcp-audiense-di-linkedin.

Indexed server id: github-audienseco-mcp-audiense-di-linkedin-fcd41e71
Name: AudienseCo/mcp-audiense-di-linkedin
Category: Social Media & Content Platforms
Source docs: docs/social-media--content-platforms.md
