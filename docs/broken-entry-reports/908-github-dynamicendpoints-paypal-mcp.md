# Broken entry report: https://github.com/DynamicEndpoints/Paypal-MCP

Status: needs verification
Source issue: https://github.com/TensorBlock/awesome-mcp-servers/issues/908

## Entry Reference

https://github.com/DynamicEndpoints/Paypal-MCP
...
GitHub API returned 404 for https://github.com/DynamicEndpoints/Paypal-MCP.

Indexed server id: github-dynamicendpoints-paypal-mcp-a149184f
Name: DynamicEndpoints/Paypal-MCP
Category: Marketing, Sales & CRM
Source docs: docs/marketing-sales--crm.md
