# Broken entry report: https://github.com/jayjex/dataset-mcp

Status: needs verification
Source issue: https://github.com/TensorBlock/awesome-mcp-servers/issues/2499

## Entry Reference

https://github.com/jayjex/dataset-mcp
...
GitHub API returned 404 for https://github.com/jayjex/dataset-mcp.

Indexed server id: github-jayjex-dataset-mcp-406d2bd1
Name: jayjex/dataset-mcp
Category: Databases
Source docs: docs/databases.md
