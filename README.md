...
- [voidly-ai/voidly-pay](https://github.com/voidly-ai/voidly-pay): x402 facilitator and agent payment rail with transfers, escrow, streams (per-token / per-second metering), subscriptions, batch payouts, and a marketplace of 17 paid endpoints. USDC settlement on Base via a Sourcify-verified vault. 42 MCP tools, free 10-credit faucet at /pay/claim.
