...
- [grahammccain/chart-library-mcp](https://github.com/grahammccain/chart-library-mcp) - Historical chart pattern search engine with 19 MCP tools. Search 24M+ pre-computed embeddings across 15K+ symbols and 10 years of data for similar patterns and forward returns. Install: `pip install chartlibrary-mcp`.
