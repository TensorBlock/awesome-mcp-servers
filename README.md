...
- [COSAI-Labs/toolpipe-mcp-server](https://github.com/COSAI-Labs/make-money-30day-challenge/tree/master/products/mcp-server): 88 developer tools (JSON formatting, QR codes, hashing, UUID, DNS lookup, regex, JWT, SQL formatting, XML, YAML, PDF extraction, web scraping, code analysis) bundled into a single MCP server. Install with `npx @cosai-labs/toolpipe-mcp-server`.
## 📁 Filesystems
