...
- [Overboard Studio](https://github.com/alona-iaig/overboard-claude-plugin) - AI-powered collaborative whiteboard. Create boards, diagrams, flowcharts, and project plans from AI conversations. 17 MCP tools, OAuth 2.0 + PKCE, real-time collaboration, free unlimited boards.
