...
- [CorpusIQ](https://github.com/CorpusIQ/corpusiq-docs): Connect 36+ business tools (Shopify, QuickBooks, HubSpot, Stripe, GA4, Klaviyo, Meta Ads, and more) to Claude, ChatGPT, and any MCP agent via a single remote endpoint. OAuth 2.0 device flow — no browser required. Remote MCP endpoint: https://mcp2.corpusiq.io/mcp
