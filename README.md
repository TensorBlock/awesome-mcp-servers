...
- [ElromEvedElElyon/claw-mcp-toolkit](https://github.com/ElromEvedElElyon/claw-mcp-toolkit): All-in-one MCP toolkit with 26 tools across 5 modules (crypto, web, social, finance, productivity). Real-time prices, Fear & Greed Index, trending coins, market overview, stock prices, forex rates. Zero API keys, zero config. MIT license.
