...
- [COSAI-Labs/toolpipe-mcp-server](https://github.com/COSAI-Labs/toolpipe-mcp-server) - 135+ developer utility tools (JSON formatting, QR codes, hashing, PDF tools, regex, JWT, UUID, SSL checks, DNS lookups, text processing, date/time, encoding, math, color conversion) as MCP tools. No API keys required. Available via npm: `npx @cosai-labs/toolpipe-mcp-server`.
...
- [COSAI-Labs/toolpipe-mcp-server](https://github.com/COSAI-Labs/toolpipe-mcp-server): MCP server providing 135+ developer utility tools including JSON formatting, hash generation, QR codes, PDF tools, regex testing, JWT decoding, UUID generation, SSL checking, and more. Install via npm: `@cosai-labs/toolpipe-mcp-server`.
