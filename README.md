...
- [Composer](https://github.com/OliverGrabner/composer-mcp) - Visual architecture canvas where agents build, read, and modify system design diagrams with real-time sync.
## 📁 Filesystems
