...
- [sceneview/sceneview](https://github.com/sceneview/sceneview/tree/main/mcp): 3D & AR SDK MCP server for 9 platforms (Android, iOS, Web, Desktop, TV, Flutter, React Native) — API docs, code generation, validation, samples, and interactive 3D preview rendering via Filament.js.
