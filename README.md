...
- [aidi1723/OmniGlyph](https://github.com/aidi1723/OmniGlyph): Local symbol ground-truth MCP server for Unicode/Unihan lookup, domain-term normalization, output guardrails, and code-symbol linting. Detects homoglyphs, zero-width spaces, and suspicious Unicode before agents reason over text. Published on PyPI as `omniglyph` and registered in the MCP Registry.
