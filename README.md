...
- [protect-mcp](https://github.com/tomjwxf/scopeblind-gateway): Security gateway that wraps any MCP server with per-tool policies (Cedar + JSON), Ed25519-signed decision receipts, trust tiers, and human-approval gates. Shadow mode by default. Receipt format specified in [IETF Internet-Draft](https://datatracker.ietf.org/doc/draft-farley-acta-signed-receipts/). MIT licensed. Install: `npx protect-mcp -- node server.js`
