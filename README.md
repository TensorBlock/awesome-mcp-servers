...
- [COSAI-Labs/toolpipe-mcp-server](https://github.com/COSAI-Labs/make-money-30day-challenge/tree/master/products/mcp-server): 230+ developer utility tools via MCP: JSON/XML/YAML processing, QR codes, hashing, UUID, DNS, WHOIS, PDF generation, code review, fake data, web scraping, SEO analysis, and more. Install: `npx @cosai-labs/toolpipe-mcp-server`. [toolpipe.dev](https://toolpipe.dev)
