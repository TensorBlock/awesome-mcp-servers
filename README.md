...
- [7xuanlu/origin](https://github.com/7xuanlu/origin): Local-first memory layer for AI work. Captures decisions, handoffs, and project context, then serves source-backed recall, distilled Markdown pages, graph context, and hybrid retrieval across MCP clients.
