...
- [USDVCapital/api.usdvcapital.com](https://github.com/USDVCapital/api.usdvcapital.com): Real estate market intelligence, financial calculators (DSCR, Flip ROI, BRRRR, Rental Cash Flow, STR Revenue, Construction, Deal Analysis), investment screening, and capital advisory covering all 50 US states + DC + PR. 86K+ locations with Census ACS and Zillow data. 23 tools via Streamable HTTP, no auth required.
