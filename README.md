...
- [Pyrimid](https://github.com/pyrimid-ai/pyrimid): MCP server and x402 catalog for paid AI/API products, paid MCP tools, and agent-to-agent commerce on Base USDC.
