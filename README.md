...
- [SolvoHQ/llmcapplanner](https://github.com/SolvoHQ/llmcapplanner) - Deterministic offline calculator: given provider/model/tier/RPM/input+output tokens, returns projected monthly LLM API cost and which rate-limit dimension (RPM/ITPM/OTPM/TPM) 429s first, computed against a dated May-2026 Anthropic/OpenAI pricing + rate-limit snapshot. Does not call any LLM API itself.
## 📁 Filesystems
