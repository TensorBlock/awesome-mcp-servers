...
- [proompteng/bilig](https://github.com/proompteng/bilig): Formula WorkPaper MCP server for agent tools that need to read ranges, write cells, recalculate formulas, and persist workbook JSON without driving a spreadsheet UI.
