...
- [decantr-ai/decantr](https://github.com/decantr-ai/decantr/tree/main/packages/mcp-server) - Design intelligence for AI-generated UI: structured design context, open pattern registry, and drift detection for Claude/Cursor/Windsurf. `npx -y @decantr/mcp-server`
## 📁 Filesystems
