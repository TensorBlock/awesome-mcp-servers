...
- [dakera-ai/dakera-mcp](https://github.com/dakera-ai/dakera-mcp): Self-hosted MCP-native agent memory server written in Rust. Decay-weighted episodic memory with 83 tools, RocksDB + HNSW vector search, 87.8% LoCoMo benchmark score. Fully offline, multi-SDK support (Python/JS/Rust/Go), Docker Compose deployment.
