...
- [connerlambden/helium-mcp](https://github.com/connerlambden/helium-mcp): Free remote MCP + REST server combining ML-derived options pricing (per-symbol fair value, prob_ITM, Greeks) with structured news intelligence (3.2M+ articles, 31-dim bias scoring including AI-authorship probability). 10 endpoints, 50 free queries per IP.
