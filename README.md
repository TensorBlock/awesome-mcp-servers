...
- [COSAI-Labs/toolpipe-mcp-server](https://github.com/COSAI-Labs/toolpipe-mcp-server): MCP server and REST API providing 120+ free developer utility tools including hashing, encoding, JSON/YAML/CSV conversion, UUID generation, JWT operations, DNS lookup, and more. No API key required. `npx @cosai-labs/toolpipe-mcp-server`
